    ...
    class Program
    {
        ...
        static void CharFunctionality()
        {
            ...
            Console.WriteLine("char.IsWhiteSpace('Hello There', 5): {0}",
              char.IsWhiteSpace("Helfaflo There", 5));
        ...
        static void UseDatesAndTimes()
        {
            ...
            DateTime dt1 = new DateTime(2018, 7, 19);
            Console.WriteLine(dt1);
            Console.WriteLine("今天是{0}月的第{1}天", dt1.Date,dt1.DayOfWeek);
            Console.WriteLine();
            Console.WriteLine();
            ...
            Console.WriteLine("The day of {0} is {1}", dt.Date, dt.Day);

            // Month is now December.
            dt = dt.AddMonths(2);
            Console.WriteLine("The day  is {0}", dt.Date);
