...
namespace FunWithStrings
{
    class Program
    {
        ...
        static void BasicStringFunctionality()
        {
            ...
            string ss = "faljfAFLJLFAFAjljtj00";
            Console.WriteLine("ss has {0} characters.", ss.Length);
            Console.WriteLine("ss in uppercase: {0}", ss.ToUpper());
            Console.WriteLine("ss in uppercase: {0}", ss.ToLower());
            Console.WriteLine("\a");
            Console.WriteLine("\n");
        }
        #endregion
        ...
        static void StringEquality()
        {
            ...
            Console.WriteLine("s1 == HELLO!: {0}", s1 == "HELLO!");
            Console.WriteLine("s1 == hello!: {0}", s1 == "hello!");
            Console.WriteLine("s1.Equals(s2): {0}", s2.Equals(s2));
            ...
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine("{0}",s2.Equals("Yo!"));
